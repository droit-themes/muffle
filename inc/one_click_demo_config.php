...
add_filter( 'pt-ocdi/import_files', 'muffle_import_files' );
function muffle_import_files() {
    return array(

        array(
            'import_file_name'             => esc_html__('Light Demos', 'muffle'),
            ...
            'preview_url'                  => 'https://muffle.droitlab.com/',
...
function muffle_after_import_setup() {
...
add_action( 'pt-ocdi/after_import', 'muffle_after_import_setup' );