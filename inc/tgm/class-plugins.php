	...
	public function register_required_plugins( $plugins ) {
		...
		$new_plugins = array(
			...
			array(
				...
				'source'             => 'http://muffle.droitlab.com/downloadfile/muffle-core_1.0.3.zip', // The plugin source.
			...
			array(
				'name'               => esc_html__( 'Droit Addons For Elementor', 'muffle' ), // The plugin name.
			...
			array(
				'name'               => esc_html__( 'Droit Dark', 'muffle' ), // The plugin name.
