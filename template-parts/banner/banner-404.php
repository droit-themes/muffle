...
$show_banner = muffle_options('muffle_404_banner_toggle', 'show');
$banner_title = muffle_options('muffle_404_banner_title', '404');
  
$banner_url = muffle_options('muffle_404_banner_upload');

$how_title = muffle_options('muffle_404_banner_title', 'show');
$show_breadcrumbs = muffle_options('muffle_404_banner_breadcrumb', 'show');
