...
Redux::setSection( 'muffle', array(
    ...
    'fields'           => array(
        ...
        array(
            'id'       => 'muffle_primary_color',
            'type'     => 'color',
            'title'    => __('Primary Color', 'muffle'), 
            'desc'     => __('Primary color work at all Headding tag Color', 'muffle'), 
            'validate' => 'color',
            'mode'     => 'color',
        ...
        array(
            'id'       => 'muffle_secondary_color',
            'type'     => 'color',
            'title'    => __('Secondary Color', 'muffle'), 
            'desc'     => __('Secondary color work at Blog Title , Page Title , Widget Title & Comment area title', 'muffle'), 
            'validate' => 'color',
            'output'   => array(
        ...
        array(
            'id'       => 'muffle_body_color',
            'type'     => 'color',
            'title'    => __('Body Color', 'muffle'),
            'desc'     => __('Body color work at Body color , Sideber ul-li, Comment content', 'muffle'), 
            'validate' => 'color',
            'mode'     => 'color',
        ...
        array(
            'id'       => 'muffle_link_color',
            'type'     => 'color',
            'title'    => __('Link Color', 'muffle'),
            'desc'     => __('Link color work at All Link Color Without Menu Section', 'muffle'), 
            'validate' => 'color',
            'mode'     => 'color',
        ...
        array(
            'id'       => 'muffle_link_hover_color',
            'type'     => 'color',
            'title'    => __('Link Hover Color', 'muffle'),
            'desc'     => __('Link color work at All type Hover Color Without Menu Section', 'muffle'),
            'validate' => 'color',
            'output'   => array(
